...
class Tornado {
  constructor() {
    ...
    this.angle = 0;
    this.img = document.createElement("img");
    this.img.src = "https://i.imgur.com/qICad63.png"
    this.speed = 0;
  }
...
class Magnet {
  constructor() {
    ...
    this.time = 5000;
    this.img = document.createElement("img");
    this.img.src = "https://i.imgur.com/fCYobX1.png";
  ...
  active(me, op) {
    ...
    setTimeout(function(){t.stopSucking(suckTimer);}, this.time);
  }
...
class Stop9 {
  constructor() {
    ...
    this.time = 3000;
    this.img = document.createElement("img");
    this.img.src = "https://i.imgur.com/N1mGn9N.jpg";
  }
